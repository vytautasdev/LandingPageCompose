...
import com.vytautasdev.components.SkillBar
import com.vytautasdev.models.Section
import com.vytautasdev.models.Skill
import com.vytautasdev.models.Theme
import com.vytautasdev.styles.AboutImageStyle
import com.vytautasdev.styles.AboutTextStyle
...
fun AboutContent() {
    ...
    Column(
        modifier = Modifier
            .fillMaxWidth(
                if (breakpoint >= Breakpoint.ZERO) 90.percent
                else 100.percent
            )
            .maxWidth(1200.px),
...
fun AboutMe() {
    ...
    val animatedPercentage = remember { mutableStateListOf(0, 0, 0, 0, 0, 0, 0, 0) }
    ...
    Column(
        ...
        Skill.values().forEach { skill ->
            SkillBar(
                ...
                animatedPercentageValue = if (viewportEntered) animatedPercentage[skill.ordinal] else 0
            )
        }
    }
}